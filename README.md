...
<style>
  ...
  * { box-sizing: border-box; font-family: sans-serif; margin: 0; padding: 0; }
  ...
  .card { background: var(--paper); border: 1px solid var(--rice-2); border-radius: 8px; padding: 12px; display: flex; flex-direction: column; gap: 8px; }
  .pimg { width: 100%; height: 110px; object-fit: cover; border-radius: 6px; background: #eee; }
  .pname { font-weight: bold; font-size: 14px; min-height: 36px; line-height: 1.3; }
  .punit { font-size: 12px; color: #666; margin-bottom: 4px; }
...
const catalog = [
  { id:"veg", name:"🍅 Fresh Vegetables", items:[
    ["Onion", "1kg", 1.99, "https://images.unsplash.com/photo-1618519764620-7403abdbfee9?w=400&auto=format&fit=crop&q=60"], 
    ["Tomato", "1kg", 2.49, "https://images.unsplash.com/photo-1595855759920-86582396756a?w=400&auto=format&fit=crop&q=60"], 
    ["Potato", "1kg", 1.79, "https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=400&auto=format&fit=crop&q=60"], 
    ["Green Chilli", "250g", 1.49, "https://images.unsplash.com/photo-1565599837634-134bc3aadce8?w=400&auto=format&fit=crop&q=60"]
  ]},
  { id:"rice", name:"🌾 Rice & Flour", items:[
    ["Idli Rice", "5kg", 9.99, "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&auto=format&fit=crop&q=60"], 
    ["Ponni Rice", "5kg", 11.49, "https://images.unsplash.com/photo-1536304997881-a372c179924b?w=400&auto=format&fit=crop&q=60"]
  ]},
  { id:"dal", name:"🥣 Dals & Pulses", items:[
    ["Toor Dal", "1kg", 3.49, "https://images.unsplash.com/photo-1547058881-aa0edd92aab3?w=400&auto=format&fit=crop&q=60"], 
    ["Moong Dal", "1kg", 3.29, "https://images.unsplash.com/photo-1600180758890-6b945f9a2ba6?w=400&auto=format&fit=crop&q=60"]
  ]}
];
let cart = {};
...
function renderCatalog() {
  ...
  catalog.forEach(cat => {
    ...
    cat.items.forEach(([name, unit, price, img]) => {
      ...
      html += `<div class="card">
        <img class="pimg" src="${img}" alt="${name}">
